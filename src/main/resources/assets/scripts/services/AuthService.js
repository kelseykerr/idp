  ...
  .factory('authService', ['$http', '$cookies', '$rootScope', 'Base64', function ($http, $cookies, $rootScope, Base64) {
    ...
    return {
      ...
      signIn: function (creds) {
        return $http.post('api/auth/signin', creds);
      },

      signUp: function (creds) {
        return $http.post('api/auth/signup', creds);
      },

      setCreds: function (email, password) {
        return Base64.encode(email + ':' + password);
      },

      setUserInfo: function (userInfo, email, password) {
